...
class PasswordResetEmailVerifyAPIView(generics.RetrieveAPIView):
    ...
    def get_object(self):
        ...
        if user:
            ...
            headers = {
                "Authorization": "Bearer 4fe903885cc9134fe0d568c8c6954383",
                "Content-Type": "application/json"
            }

            response = requests.post("https://sandbox.api.mailtrap.io/api/send/3609660", headers=headers, data=json.dumps(payload))
